  ...
  return (
    <ScrollView contentContainerStyle={{backgroundColor: "#FFFFFF", flex: 1, paddingHorizontal: 40, flexDirection: "column", justifyContent: "space-between", paddingBottom: 40}}>
          ...
          <View style={{flexDirection: "column", gap: 20}}>
            <Text style={{fontSize: 38, color: "#323142", fontWeight: "bold", marginBottom: 40}} >Login Your{"\n"}
            Account</Text>
          ...
          <Link style={{fontSize: 16, color: "#323142", fontWeight: "medium", textAlign: "right"}} href="/auths/reset">Forgotten Password?</Link>
            <TouchableOpacity style={{backgroundColor: "#141718", height: 65, borderRadius: 14, justifyContent: 'center', alignItems: "center"}}>
              <Text style={{fontSize: 16, color: "#F3F5F6", fontWeight: "medium", textAlign: "center"}}>Login</Text>
            </TouchableOpacity>
            <View style={{flexDirection: "row", alignItems: "center", gap: 5, justifyContent: "center" }}>
              <Text style={{ fontSize: 16, color: "#ACADB9", fontWeight: "medium" }}>Create New account.</Text>
              <Link style={{ fontSize: 16, color: "#323142", fontWeight: "semibold" }} href="/auths/login">Sign Up</Link>
            </View>
          </View>
          <View>
